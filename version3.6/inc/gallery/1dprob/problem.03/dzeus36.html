...
#                                                                      #
#               Advection in spherical polar coordinates               #
#                                                                      #
...
cat << EOF > ./inzeus
 ...
 \$pl1con   dtpl1=1.0, pl1dir=1, corl=1, aspect=0.9, npl1h=3, npl1v=3
         ...
         , pl1var= 'd ', 'e1',  'v1', 'v2', 'v3',  'b1', 'b2', 'b3'
         , pl1ref=20.09,20.09,-1.e32,2.718,2.718,-1.e32,7.389,7.389
         , pl1min=19.5 ,7*0.0, pl1max=20.2 ,7*0.0                      \$
 \$pl2con                                                               \$
 \$pixcon                                                               \$
 \$usrcon                                                               \$
 \$hdfcon                                                               \$
