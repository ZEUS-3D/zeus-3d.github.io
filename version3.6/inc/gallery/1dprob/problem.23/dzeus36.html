...
#                                                                      #
#                Ambipolar diffusion C-shock (adiabatic)               #
#                                                                      #
#  last dt=1.384476708422483E-03, nhy=2825                             #
#                                                                      #
...
cat << EOF > ./inzeus
 ...
 \$pgen     idirect=1, n0=100, b10=0.7071, b30=0.0
         , d0=7.976, p10=0.50, v10=0.627 , v20=0.830, b20=6.576        \$
EOF
#============================================> MAKE the ZEUS executable.
make -f ./makezeus
#===================================================> Tidy up directory.
rm -f ./editlp ./inedit ./output
