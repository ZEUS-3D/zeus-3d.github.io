...
#                                                                      #
#                       Ryu & Jones (1995) Fig 5a                      #
#                                                                      #
#  last dt=1.055954002178555E-05, nhy=392                              #
#                                                                      #
...
cat << EOF > ./inzeus
 ...
 \$hycon    qcon=1.0, qlin=0.5, courno=0.75, iord=2, iords=3, istp=2
         , trnvrsn=1, itote=1                                          \$
 \$iib      niib(1,1)=9                                                 \$
 \$oib      noib(1,1)=9                                                 \$
 \$ijb                                                                  \$
 ...
 \$gcon                                                                 \$
 \$extcon                                                               \$
 \$pl1con   dtpl1=0.1, pl1dir=1, corl=1, aspect=0.9, npl1h=3, npl1v=3
 ...
 \$pgen     idirect=1, n0=256, d0=1.0, v10=0.0, v20=0.0, v30=0.0
         , b20=1.0, b30=0.0, p10=1.0, b10=0.75                         \$
 \$pgen     idirect=1, n0=256, d0=0.125, v10=0.0, v20=0.0, v30=0.0
         , b20=-1.0, b30=0.0, p10=0.1, b10=0.75                        \$
EOF
