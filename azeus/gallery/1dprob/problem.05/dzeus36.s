...
#                                                                      #
#               Relaxation in spherical polar coordinates              #
#                                                                      #
...
cat << EOF > ./inzeus
 ...
 \$gcon                                                                 \$
 \$extcon                                                               \$
 \$pl1con   dtpl1=2.0, pl1dir=1, corl=1, aspect=1.0, npl1h=3, npl1v=2
         , norppl1=2, pl1ftr=1, allxl=1, pl1hdr=0, pl1mm=0
         , pl1var=  'd ',  'e1', 'v2', 'v3', 'b2', 'b3'
         , pl1min=.00230,.00230, 4*0.0
         , pl1max=.00250,.00250,  .02,  .02,.0026,.0026
         , pl1ref=2*.0024789,2*.018316,2*.00248                        \$
 \$pl2con                                                               \$
 \$pixcon                                                               \$
 \$usrcon                                                               \$
 \$hdfcon                                                               \$
 ...
 \$discon                                                               \$
 \$radcon                                                               \$
 \$pgen     idirect=1, d0=1.0, v0=1.0
         , advvar='e1','v2','v3','b2','b3'
         , ishp=1,4*6, amp=5*1.0, floor=5*1.0                          \$
EOF
