...
#                                                                      #
#           1-D Alfven waves and periodic boundary conditions          #
#                                                                      #
...
cat << EOF > ./inzeus
 ...
 \$ggen1    nbl=250, x1min=0.0, x1max=1.0, igrid=1, x1rat=1.0, lgrid=.t.\$
 \$ggen2                                                                \$
 \$ggen3                                                                \$
 \$pcon     nlim= 999999, tlim=-0.7, ttotal=900.0, tsave=10.0           \$
 \$hycon    qcon=0.0, qlin=0.0, courno=1.0, iord=2, iords=2, istp=0
         , trnvrsn=1, itote=1                                          \$
 \$iib      niib(1,1)=5                                                 \$
 \$oib      noib(1,1)=5                                                 \$
 \$ijb                                                                  \$
 ...
 \$gcon                                                                 \$
 \$extcon                                                               \$
 \$pl1con   pl1dir=1, dtpl1=0.7, corl=1, aspect=0.9, npl1h=2, npl1v=2
         , norppl1=2, pl1ftr=1, allxl=1, pl1hdr=0
         , pl1var= 'v2', 'b2', 'v3', 'b3'                              \$
 \$pl2con                                                               \$
 \$pixcon                                                               \$
 \$usrcon                                                               \$
 ...
 \$discon                                                               \$
 \$radcon                                                               \$
 \$pgen     idirect=1, n0=100, d0=1.0, e10=0.9, v10=0.00, v20=0.0
         , v30=0.000, b10=1.0, isetib=0, isetob=0                      \$
 \$pgen     idirect=1, n0=50, d0=1.0, e10=0.9, v10=0.00, v20=0.001
         , v30=0.001, b10=1.0                                          \$
 \$pgen     idirect=1, n0=100, d0=1.0, e10=0.9, v10=0.00, v20=0.0
         , v30=0.000, b10=1.0                                          \$
EOF
