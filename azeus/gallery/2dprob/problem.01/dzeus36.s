...
#                             2-D Advection                            #
#                                                                      #
#  last dt=6.845576173903485E-04, nhy=347                              #
#                                                                      #
...
cat << EOF > ./inzeus
 ...
 \$ggen3                                                                \$
 \$pcon     nlim= 999999, tlim=-0.5, ttotal=2000.0, tsave=10.0          \$
 \$hycon    qcon=2.0, qlin=0.0, courno=0.5, iord=2, istp=0
c \$hycon    qcon=2.0, qlin=0.0, courno=1.7320508, iord=2, istp=0
 ...
 \$extcon                                                               \$
 \$pl1con                                                               \$
 \$pl2con   pl2dir=3, dtpl2=0.5, norppl2=2, pl2xl=0, pl2yl=0, pl2ftr=0
         , pl2ccol=-2, pl2leg=0 
         , pl2sca1='e1','et','vn','bn'                                 \$
 \$pixcon   dtpix=0.0025, pixdir=3, npixi=300, npixj=300, pixmm=0
         , pixfmt=1, ppmpix=0, iflippix=1
         , pixvar='e1','et','vn','bn' 
         , pixmin=0.9,1.9,0.0,0.0
         , pixmax=0.90098,1.90098,0.00098,0.00098                      \$
 \$usrcon                                                               \$
 \$hdfcon                                                               \$
 \$tslcon   dttsp=0.01, norptsp=2                                       \$
 \$crkcon                                                               \$
 \$discon                                                               \$
 \$radcon                                                               \$
 \$pgen     nbox=2
         ...
         , dbox= 1.0,1.0  , e1box=0.9,0.901
         , v3box=0.0,0.001, v1box=1.0,1.0
         , v2box=1.0,1.0  , b3box=0.0,0.001
         , b1box=0.0,0.0  , b2box=0.0,0.0                              \$
EOF
